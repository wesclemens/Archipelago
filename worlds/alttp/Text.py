...
class TextTable(object):
    ...
    def setDefaultText(self):
        ...
        text['death_mountain_bullied_no_pearl'] = CompressedTextMapper.convert("Dave, You are welcome")
        text['death_mountain_bullied_with_pearl'] = CompressedTextMapper.convert("Dave, You are welcome")
